                        ...
                        <Carousel className='desktop'>
                            ...
                            <Carousel.Item>
                                <div className="row">
                                    ...
                                    <div className="col-md-2">
                                        <img src="assets/img/uploads/2022/01/17-370x422.png" alt="second slide" className='img-fluid' />
                                        <h6>Hydroponics</h6>
                                        <h4>Basil (50g)</h4>
                                        <h5>₹50.00</h5>
                                        <div className='product-tool'>
                            ...
                            <Carousel.Item>
                                <div className="row">
                                    ...
                                    <div className="col-md-2">
                                        <img src="assets/img/uploads/2022/01/66-370x422.png" alt="third slide" className='img-fluid' />
                                        <h6>Hydroponics</h6>
                                        <h4>Spinach (1kg)</h4>
                                        <h5>₹72.00</h5>
                                        <div className='product-tool'>
                                    ...
                                    <div className="col-md-2">
                                        <img src="assets/img/uploads/2022/01/64-370x422.png" alt="third slide" className='img-fluid' />
                                        <h6>Hydroponics</h6>
                                        <h4>Pak Choi White (250g)</h4>
                                        <h5>₹120.00</h5>
                                        <div className='product-tool'>
