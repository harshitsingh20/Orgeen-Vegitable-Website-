...
class Categories extends React.Component {
  ...
  handleUpdate = (e) => {
    ...
    axios.post('http://localhost:5000/api/update_categories', updatedata)
      .then(response => {
...
loaded () {
  ...
  render() {
    const { id, name, slug, description, parent_category } = this.state
    const data = {
      columns: [
        {
          label: "Id",
                    ...
                    <div class="modal-body">
                      <form onSubmit={this.handleUpdate}>
                        ...
                        <div className="form-group">
                          ...
                          <input type="text" name="slug" className="form-control" defaultValue={slug} onChange={this.getSingleCategory} id="slug" />
                        </div>
                        <div className="form-group">
                        ...
                        <div className="form-group">
                          ...
                          <textarea name="description" className="form-control" id="description" defaultValue={description} onChange={this.getSingleCategory} ></textarea>
                        </div>
